...
/***/ function(module, exports, __webpack_require__) {
	...
	var play_move = function play_move(index) {
	  if (board[index] !== '') {
	...
	var checkWinner = function checkWinner() {
	  if (board[0] !== '' && board[0] === board[4] && board[0] === board[8] || board[2] !== '' && board[2] === board[4] && board[2] === board[6]) {
	    // console.log('You Win!');
	    winner = true;
	    return true;
	  } else if (board[0] !== '' && board[0] === board[1] && board[0] === board[2] || board[3] !== '' && board[3] === board[4] && board[3] === board[5] || board[6] !== '' && board[6] === board[7] && board[6] === board[8]) {
	    // console.log('You Win!');
	    winner = true;
	    return true;
	...
	var runGame = function runGame(event) {
	  switchPlayer();
	...
	var resetBoard = function resetBoard() {
	  ...
	  }).then(onCreateGameSuccess).catch(onCreateGameFailure);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var storeGame = function storeGame(player, winner, index) {
	  return $.ajax({
	    method: 'PATCH',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onChangePassword = function onChangePassword(event) {
	  ...
	  api.changePassword(data).then(ui.success)
	  // .catch(ui.failure)
	  ;
	};
	...
	var onSignOut = function onSignOut(event) {
	  ...
	  api.signOut(data).then(ui.onSignOutSuccess)
	  // .catch(ui.failure)
	  ;
	};
	...
	var onShowGame = function onShowGame(event) {
	  ...
	  api.showGames().then(ui.showGameSuccess)
	  // .catch(ui.failure)
	  ;
	};
